  ...
  return (
    <footer className="flex-row mt-4 p-2 bg-black-vct flex justify-evenly items-center">
      ...
      <div className='flex flex-col items-center'>
        <p className=" text-white text-center text-[10px] font-thin my-auto w-36 sm:w-fit">Desarrollado por grupo Capstone 2024-1</p>
        <p className=" text-white text-center text-[10px] font-thin my-auto w-36 sm:w-fit">Universidad Católica del Norte</p>
      </div>
